<template>
  <div v-if="show">
    <h1>
      Sao phải tìm đến cái nút từ chối tận {{ signal }} lần thế? <br />
      Muốn nói gì với t không? 👇👇
    </h1>
  ...
  <div v-if="!show">
    <h1>Cảm ơn bạn Ly đã mở và xem hết gói quà nhỏ này!! <br /></h1>
  </div>
</template>
